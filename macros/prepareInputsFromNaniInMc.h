...
#define prepareInputsFromNaniInMc_h
...
class prepareInputsFromNaniInMc {
 public :
  ...
  ULong64_t       event;
  UInt_t          nBToKEE;
  Float_t         BToKEE_b_iso03[1500];   //[nBToKEE]
  Float_t         BToKEE_b_iso03_dca[1500];   //[nBToKEE]
  Float_t         BToKEE_b_iso03_dca_tight[1500];   //[nBToKEE]
  Float_t         BToKEE_b_iso04[1500];   //[nBToKEE]
  Float_t         BToKEE_b_iso04_dca[1500];   //[nBToKEE]
  Float_t         BToKEE_b_iso04_dca_tight[1500];   //[nBToKEE]
  Float_t         BToKEE_cos2D[1500];   //[nBToKEE]
  Float_t         BToKEE_eta[1500];   //[nBToKEE]
  Float_t         BToKEE_fit_cos2D[1500];   //[nBToKEE]
  Float_t         BToKEE_fit_eta[1500];   //[nBToKEE]
  Float_t         BToKEE_fit_k_eta[1500];   //[nBToKEE]
  Float_t         BToKEE_fit_k_phi[1500];   //[nBToKEE]
  Float_t         BToKEE_fit_k_pt[1500];   //[nBToKEE]
  Float_t         BToKEE_fit_l1_eta[1500];   //[nBToKEE]
  Float_t         BToKEE_fit_l1_phi[1500];   //[nBToKEE]
  Float_t         BToKEE_fit_l1_pt[1500];   //[nBToKEE]
  Float_t         BToKEE_fit_l2_eta[1500];   //[nBToKEE]
  Float_t         BToKEE_fit_l2_phi[1500];   //[nBToKEE]
  Float_t         BToKEE_fit_l2_pt[1500];   //[nBToKEE]
  Float_t         BToKEE_fit_mass[1500];   //[nBToKEE]
  Float_t         BToKEE_fit_massErr[1500];   //[nBToKEE]
  Float_t         BToKEE_fit_phi[1500];   //[nBToKEE]
  Float_t         BToKEE_fit_pt[1500];   //[nBToKEE]
  Float_t         BToKEE_k_iso03[1500];   //[nBToKEE]
  Float_t         BToKEE_k_iso03_dca[1500];   //[nBToKEE]
  Float_t         BToKEE_k_iso03_dca_tight[1500];   //[nBToKEE]
  Float_t         BToKEE_k_iso04[1500];   //[nBToKEE]
  Float_t         BToKEE_k_iso04_dca[1500];   //[nBToKEE]
  Float_t         BToKEE_k_iso04_dca_tight[1500];   //[nBToKEE]
  Float_t         BToKEE_k_svip2d[1500];   //[nBToKEE]
  Float_t         BToKEE_k_svip2d_err[1500];   //[nBToKEE]
  Float_t         BToKEE_k_svip3d[1500];   //[nBToKEE]
  Float_t         BToKEE_k_svip3d_err[1500];   //[nBToKEE]
  Float_t         BToKEE_l1_iso03[1500];   //[nBToKEE]
  Float_t         BToKEE_l1_iso03_dca[1500];   //[nBToKEE]
  Float_t         BToKEE_l1_iso03_dca_tight[1500];   //[nBToKEE]
  Float_t         BToKEE_l1_iso04[1500];   //[nBToKEE]
  Float_t         BToKEE_l1_iso04_dca[1500];   //[nBToKEE]
  Float_t         BToKEE_l1_iso04_dca_tight[1500];   //[nBToKEE]
  Float_t         BToKEE_l2_iso03[1500];   //[nBToKEE]
  Float_t         BToKEE_l2_iso03_dca[1500];   //[nBToKEE]
  Float_t         BToKEE_l2_iso03_dca_tight[1500];   //[nBToKEE]
  Float_t         BToKEE_l2_iso04[1500];   //[nBToKEE]
  Float_t         BToKEE_l2_iso04_dca[1500];   //[nBToKEE]
  Float_t         BToKEE_l2_iso04_dca_tight[1500];   //[nBToKEE]
  Float_t         BToKEE_l_xy[1500];   //[nBToKEE]
  Float_t         BToKEE_l_xy_unc[1500];   //[nBToKEE]
  Float_t         BToKEE_mass[1500];   //[nBToKEE]
  Float_t         BToKEE_maxDR[1500];   //[nBToKEE]
  Float_t         BToKEE_minDR[1500];   //[nBToKEE]
  Float_t         BToKEE_mllErr_llfit[1500];   //[nBToKEE]
  Float_t         BToKEE_mll_fullfit[1500];   //[nBToKEE]
  Float_t         BToKEE_mll_llfit[1500];   //[nBToKEE]
  Float_t         BToKEE_mll_raw[1500];   //[nBToKEE]
  Float_t         BToKEE_phi[1500];   //[nBToKEE]
  Float_t         BToKEE_pt[1500];   //[nBToKEE]
  Float_t         BToKEE_svprob[1500];   //[nBToKEE]
  Float_t         BToKEE_vtx_ex[1500];   //[nBToKEE]
  Float_t         BToKEE_vtx_ey[1500];   //[nBToKEE]
  Float_t         BToKEE_vtx_ez[1500];   //[nBToKEE]
  Float_t         BToKEE_vtx_x[1500];   //[nBToKEE]
  Float_t         BToKEE_vtx_y[1500];   //[nBToKEE]
  Float_t         BToKEE_vtx_z[1500];   //[nBToKEE]
  Int_t           BToKEE_b_n_isotrk[1500];   //[nBToKEE]
  Int_t           BToKEE_b_n_isotrk_dca[1500];   //[nBToKEE]
  Int_t           BToKEE_b_n_isotrk_dca_tight[1500];   //[nBToKEE]
  Int_t           BToKEE_charge[1500];   //[nBToKEE]
  Int_t           BToKEE_kIdx[1500];   //[nBToKEE]
  Int_t           BToKEE_k_n_isotrk[1500];   //[nBToKEE]
  Int_t           BToKEE_k_n_isotrk_dca[1500];   //[nBToKEE]
  Int_t           BToKEE_k_n_isotrk_dca_tight[1500];   //[nBToKEE]
  Int_t           BToKEE_l1Idx[1500];   //[nBToKEE]
  Int_t           BToKEE_l1_n_isotrk[1500];   //[nBToKEE]
  Int_t           BToKEE_l1_n_isotrk_dca[1500];   //[nBToKEE]
  Int_t           BToKEE_l1_n_isotrk_dca_tight[1500];   //[nBToKEE]
  Int_t           BToKEE_l2Idx[1500];   //[nBToKEE]
  Int_t           BToKEE_l2_n_isotrk[1500];   //[nBToKEE]
  Int_t           BToKEE_l2_n_isotrk_dca[1500];   //[nBToKEE]
  Int_t           BToKEE_l2_n_isotrk_dca_tight[1500];   //[nBToKEE]
  Int_t           BToKEE_n_k_used[1500];   //[nBToKEE]
  Int_t           BToKEE_n_l1_used[1500];   //[nBToKEE]
  Int_t           BToKEE_n_l2_used[1500];   //[nBToKEE]
  Int_t           BToKEE_pdgId[1500];   //[nBToKEE]
  UInt_t          nBToKMuMu;
  Float_t         BToKMuMu_b_iso03[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_b_iso03_dca[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_b_iso03_dca_tight[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_b_iso04[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_b_iso04_dca[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_b_iso04_dca_tight[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_cos2D[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_eta[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_fit_cos2D[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_fit_eta[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_fit_k_eta[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_fit_k_phi[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_fit_k_pt[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_fit_l1_eta[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_fit_l1_phi[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_fit_l1_pt[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_fit_l2_eta[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_fit_l2_phi[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_fit_l2_pt[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_fit_mass[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_fit_massErr[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_fit_phi[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_fit_pt[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_k_iso03[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_k_iso03_dca[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_k_iso03_dca_tight[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_k_iso04[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_k_iso04_dca[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_k_iso04_dca_tight[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_k_svip2d[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_k_svip2d_err[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_k_svip3d[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_k_svip3d_err[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_l1_iso03[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_l1_iso03_dca[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_l1_iso03_dca_tight[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_l1_iso04[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_l1_iso04_dca[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_l1_iso04_dca_tight[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_l2_iso03[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_l2_iso03_dca[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_l2_iso03_dca_tight[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_l2_iso04[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_l2_iso04_dca[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_l2_iso04_dca_tight[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_l_xy[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_l_xy_unc[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_mass[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_maxDR[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_minDR[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_mllErr_llfit[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_mll_fullfit[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_mll_llfit[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_mll_raw[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_phi[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_pt[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_svprob[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_vtx_ex[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_vtx_ey[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_vtx_ez[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_vtx_x[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_vtx_y[600];   //[nBToKMuMu]
  Float_t         BToKMuMu_vtx_z[600];   //[nBToKMuMu]
  Int_t           BToKMuMu_b_n_isotrk[600];   //[nBToKMuMu]
  Int_t           BToKMuMu_b_n_isotrk_dca[600];   //[nBToKMuMu]
  Int_t           BToKMuMu_b_n_isotrk_dca_tight[600];   //[nBToKMuMu]
  Int_t           BToKMuMu_charge[600];   //[nBToKMuMu]
  Int_t           BToKMuMu_kIdx[600];   //[nBToKMuMu]
  Int_t           BToKMuMu_k_n_isotrk[600];   //[nBToKMuMu]
  Int_t           BToKMuMu_k_n_isotrk_dca[600];   //[nBToKMuMu]
  Int_t           BToKMuMu_k_n_isotrk_dca_tight[600];   //[nBToKMuMu]
  Int_t           BToKMuMu_l1Idx[600];   //[nBToKMuMu]
  Int_t           BToKMuMu_l1_n_isotrk[600];   //[nBToKMuMu]
  Int_t           BToKMuMu_l1_n_isotrk_dca[600];   //[nBToKMuMu]
  Int_t           BToKMuMu_l1_n_isotrk_dca_tight[600];   //[nBToKMuMu]
  Int_t           BToKMuMu_l2Idx[600];   //[nBToKMuMu]
  Int_t           BToKMuMu_l2_n_isotrk[600];   //[nBToKMuMu]
  Int_t           BToKMuMu_l2_n_isotrk_dca[600];   //[nBToKMuMu]
  Int_t           BToKMuMu_l2_n_isotrk_dca_tight[600];   //[nBToKMuMu]
  Int_t           BToKMuMu_n_k_used[600];   //[nBToKMuMu]
  Int_t           BToKMuMu_n_l1_used[600];   //[nBToKMuMu]
  Int_t           BToKMuMu_n_l2_used[600];   //[nBToKMuMu]
  Int_t           BToKMuMu_pdgId[600];   //[nBToKMuMu]
  UInt_t          nElectron;
  ...
  Float_t         Muon_matched_dpt[100];   //[nMuon]
  Float_t         Muon_matched_dr[100];   //[nMuon]
  ...
  Int_t           Muon_fired_HLT_Mu10p5_IP3p5[100];   //[nMuon]
  Int_t           Muon_fired_HLT_Mu12_IP6[100];   //[nMuon]
  Int_t           Muon_fired_HLT_Mu7_IP4[100];   //[nMuon]
  Int_t           Muon_fired_HLT_Mu8_IP3[100];   //[nMuon]
  Int_t           Muon_fired_HLT_Mu8_IP5[100];   //[nMuon]
  Int_t           Muon_fired_HLT_Mu8_IP6[100];   //[nMuon]
  Int_t           Muon_fired_HLT_Mu8p5_IP3p5[100];   //[nMuon]
  Int_t           Muon_fired_HLT_Mu9_IP4[100];   //[nMuon]
  Int_t           Muon_fired_HLT_Mu9_IP5[100];   //[nMuon]
  Int_t           Muon_fired_HLT_Mu9_IP6[100];   //[nMuon]
  Int_t           Muon_isTriggering[100];   //[nMuon]
  Int_t           Muon_looseId[100];   //[nMuon]
  ...
  UInt_t          nProbeTracks;
  Float_t         ProbeTracks_DCASig[700];   //[nProbeTracks]
  Float_t         ProbeTracks_dxy[700];   //[nProbeTracks]
  Float_t         ProbeTracks_dxyS[700];   //[nProbeTracks]
  Float_t         ProbeTracks_dz[700];   //[nProbeTracks]
  Float_t         ProbeTracks_dzS[700];   //[nProbeTracks]
  Float_t         ProbeTracks_dzTrg[700];   //[nProbeTracks]
  Float_t         ProbeTracks_eta[700];   //[nProbeTracks]
  Float_t         ProbeTracks_mass[700];   //[nProbeTracks]
  Float_t         ProbeTracks_phi[700];   //[nProbeTracks]
  Float_t         ProbeTracks_pt[700];   //[nProbeTracks]
  Float_t         ProbeTracks_vx[700];   //[nProbeTracks]
  Float_t         ProbeTracks_vy[700];   //[nProbeTracks]
  Float_t         ProbeTracks_vz[700];   //[nProbeTracks]
  Int_t           ProbeTracks_charge[700];   //[nProbeTracks]
  Int_t           ProbeTracks_isLostTrk[700];   //[nProbeTracks]
  Int_t           ProbeTracks_isPacked[700];   //[nProbeTracks]
  Int_t           ProbeTracks_nValidHits[700];   //[nProbeTracks]
  Int_t           ProbeTracks_pdgId[700];   //[nProbeTracks]
  Bool_t          ProbeTracks_isMatchedToEle[700];   //[nProbeTracks]
  Bool_t          ProbeTracks_isMatchedToLooseMuon[700];   //[nProbeTracks]
  Bool_t          ProbeTracks_isMatchedToLowPtEle[700];   //[nProbeTracks]
  Bool_t          ProbeTracks_isMatchedToMediumMuon[700];   //[nProbeTracks]
  Bool_t          ProbeTracks_isMatchedToMuon[700];   //[nProbeTracks]
  Bool_t          ProbeTracks_isMatchedToSoftMuon[700];   //[nProbeTracks]
  UChar_t         HLT_Mu7_IP4;
  UChar_t         HLT_Mu8_IP6;
  UChar_t         HLT_Mu8_IP5;
  UChar_t         HLT_Mu8_IP3;
  ...
  prepareInputsFromNaniInMc(TTree *tree=0);
  virtual ~prepareInputsFromNaniInMc();
  virtual Int_t    Cut(Long64_t entry);
  virtual Int_t    GetEntry(Long64_t entry);
  virtual Long64_t LoadTree(Long64_t entry);
  virtual void     Init(TTree *tree);
  virtual void     Loop(int testLowPt, bool studyOverlap);
...
#ifdef prepareInputsFromNaniInMc_cxx
prepareInputsFromNaniInMc::prepareInputsFromNaniInMc(TTree *tree) : fChain(0) 
{
...
prepareInputsFromNaniInMc::~prepareInputsFromNaniInMc()
{
  if (!fChain) return;
  delete fChain->GetCurrentFile();
}

Int_t prepareInputsFromNaniInMc::GetEntry(Long64_t entry)
{
...
Long64_t prepareInputsFromNaniInMc::LoadTree(Long64_t entry)
{
...
void prepareInputsFromNaniInMc::Init(TTree *tree)
{
...
Bool_t prepareInputsFromNaniInMc::Notify()
{
...
void prepareInputsFromNaniInMc::Show(Long64_t entry)
{
...
Int_t prepareInputsFromNaniInMc::Cut(Long64_t entry)
{
...
#endif // #ifdef prepareInputsFromNaniInMc_cxx
