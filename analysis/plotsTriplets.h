...
// Sat Mar 21 19:03:30 2020 by ROOT version 6.14/00
// from TTree TaPtree/TaPtree
// found on file: BuToKee_Toee_BParkNANO_mc_2020Jan16.txt.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("BuToKee_Toee_BParkNANO_mc_2020Jan16__noTagli.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("BuToKee_Toee_BParkNANO_mc_2020Jan16__noTagli.root");
      }
